...
> **Note:** This applies to Next.js, Next.js App Router, SvelteKit, Remix, Create React App, Nuxt, Vue, Astro, and other frameworks.

## Integration by Framework

Choose your framework below to see specific integration instructions:
...
#### TypeScript (Legacy Configuration)
...
#### JavaScript (Legacy Configuration)
